...
while answer.upper() == "Y":
    ...
    for i in range (0,7):
        ...
        print(f"\t\t{'|':5}  {num[i]:8} {seatA[i]}  {seatB[i]:10}{seatC[i]}  {seatD[i]}   | ")#will print the seating map
...
print("\n\t\t Thank You For Using This Program :), final data below.")
...
for i in range(0,7):
    ...
    print(f"\t\t{'|':5}  {num[i]:8} {seatA[i]}  {seatB[i]:10}{seatC[i]}  {seatD[i]}   | ")
